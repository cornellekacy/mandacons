               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="breadcromb-box">
                        <h3>General labor Available Jobs</h3>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="breadcromb-box-pagin">
                        <ul>
                           <li><a href="#">home</a></li>
                           <li class="active-breadcromb"><a href="#">General labor</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-8 col-lg-9">
                  <div class="single-candidate-bottom-left">
                     <div class="single-candidate-widget">
                        ...
                        <p>Good opportunity for someone looking to gain experience and enter the field of construction. We have a good track record for promoting people from within as they demonstrate a solid work ethic and initiative. As you progress through out company, additional training opportunities are provided as well.</p>

                       <b> Responsibilitites:</b><br>

-General labor <br>
-Driving and deliver chauffeurs license not needed <br>
-Basic carpentry <br>
-Drywall <br>
-Cleaning <br>
-Other general construction labor tasks <br><br>
<b>Skills/Requirements:</b><br>

-No previous experience needed. Will train <br>
-Must be willing to work hard <br><br>
<b>General:</b><br>
-Candidates will get a good overview of the construction industry and gain specific knowledge of tools, safety, materials, etc. <br><br>
<b>Benefits:</b><br>
                  ...
                  <div class="single-candidate-bottom-right">
                     ...
                     <div class="single-candidate-widget-2">
                        ...
                        <ul class="job-overview">
                           ...
                           <li>
                              <h4><p class="open-icon"><i class="fa fa-briefcase"></i>180 open positions</p></h4>
