               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="breadcromb-box">
                        <h3>Safety Officer Available Jobs</h3>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="breadcromb-box-pagin">
                        <ul>
                           <li><a href="#">home</a></li>
                           <li class="active-breadcromb"><a href="#">Safety Officer
</a></li>
                        </ul>
                     </div>
                  </div>
                  ...
                  <div class="single-candidate-box">
                     ...
                     <div class="single-candidate-box-right">
                        ...
                        <div class="job-details-meta">
                          ...
                          <p class="open-icon"><i class="fa fa-briefcase"></i>29 open positions</p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-8 col-lg-9">
                  <div class="single-candidate-bottom-left">
                     <div class="single-candidate-widget">
                        ...
                        <p>Hilltop construction company is seeking an experienced, professional, and dedicated individuals to fill the position of Safety Officer.</p>
        
<p>This is a non-exempt, regular part-full position.</p>

<p>This position will develop, implement, and provide oversight of a comprehensive employee safety program, risk management functions and related programs, practices and committees to include the areas of safety, accident prevention, accident investigation, safety training, equipment training, safety and training materials, and programs, procedures analysis, trend analysis, and equipment modification studies. Evaluate city practices for possible liability risks, claim trends, and personal and property damage claims.</p>
                  ...
                  <div class="single-candidate-bottom-right">
                     ...
                     <div class="single-candidate-widget-2">
                        ...
                        <ul class="job-overview">
                           ...
                           <li>
                              <h4><p class="open-icon"><i class="fa fa-briefcase"></i>29 open positions</p></h4>
