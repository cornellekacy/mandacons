               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="breadcromb-box-pagin">
                        <ul>
                           <li><a href="#">home</a></li>
                           <li class="active-breadcromb"><a href="#">Plumbers</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-9 col-lg-6">
                  <div class="single-candidate-box">
                     ...
                     <div class="single-candidate-box-right">
                        <h4>Skilled On Site Plumber</h4>
                        
                        <p>Hilltop Construction Company Ltd</p>
                        <div class="job-details-meta">
                           <p><i class="fa fa-file-text"></i> Applications Available</p>
                          <p class="open-icon"><i class="fa fa-briefcase"></i>100 open positions</p>
                        </div>
                     </div>
                  </div>
               </div>
...
-Assemble pipe sections, tubing and fittings, using couplings, clamps, screws, bolts, cement, plastic solvent, caulking, or soldering, brazing and welding equipment. <br>
-Fill pipes or plumbing fixtures with water or air and observe pressure gauges to detect and locate leaks. <br>
Study and read building plans and inspect structures to assess material and equipment needs, to establish the sequence of all plumbing pipe installations, and to plan installation around obstructions. <br>
-Measure, cut, thread, and add fitting to get required angles, using hand and power tools or machines such as pipe cutters, pipe-threading machines etc. <br>
-Install pipe assemblies, fittings, valves, appliances such as dishwashers and water heaters, and fixtures such as sinks and toilets, using hand and power tools. <br>
                  ...
                  <div class="single-candidate-bottom-right">
                     ...
                     <div class="single-candidate-widget-2">
                        ...
                        <ul class="job-overview">
                           ...
                           <li>
                              <h4><p class="open-icon"><i class="fa fa-briefcase"></i>100 open positions</p></h4>
